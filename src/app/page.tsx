  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <section className="grid items-center gap-10 py-16 md:grid-cols-[1.1fr_0.9fr] md:py-24">
        <div className="flex flex-col items-start gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/events" className="rounded-full bg-primary px-6 py-3 font-medium text-primary-foreground transition-all hover:bg-primary-hover active:translate-y-px">
              {t("browseEvents")}
            </Link>
            <Link href="/register" className="rounded-full border border-border bg-surface px-6 py-3 font-medium transition-all hover:border-foreground/30 active:translate-y-px">
              {t("registerProfile")}
            </Link>
          </div>
        </div>
      ...
      <section className="grid gap-10 border-t border-border py-16 md:grid-cols-[0.8fr_1.2fr] md:py-20">
        <div>
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">{t("howItWorks.title")}</h2>
