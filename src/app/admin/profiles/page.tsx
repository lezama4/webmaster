    ...
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      {pending.length === 0 ? (
        ...
        <ul className="flex flex-col gap-4">
          {pending.map((profile) => (
            <li key={profile.profileId} className="flex flex-col gap-4 rounded-3xl border border-border bg-surface p-6 shadow-[0_16px_40px_-28px_rgba(42,33,28,0.35)] sm:flex-row sm:items-center sm:justify-between">
